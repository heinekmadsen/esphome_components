...
wavin_ns = cg.esphome_ns.namespace('wavin')
Wavin = wavin_ns.class_('Wavin', cg.PollingComponent, modbus.ModbusDevice)

CONF_GENVEX_ID = 'wavin_id'

CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(Wavin),
